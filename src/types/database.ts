import type { BrushStyle, LayoutType, LayoutSchema, Padding, JamoData, StrokeLinecap, StrokeLinejoin, StrokeRenderStyle } from './index'
...
export const FONT_DATA_VERSION = '1.2.0'
