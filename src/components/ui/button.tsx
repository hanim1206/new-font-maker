...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-fast ease-standard cursor-pointer disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-ring/20',
  {
    variants: {
      variant: {
        default:
          'bg-surface text-text-dim-1 border border-border shadow-sm hover:bg-surface-hover hover:text-foreground',
        primary:
