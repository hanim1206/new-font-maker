...
export function HomePage() {
  ...
  const handleNewFont = () => {
    ...
    ui.setEditingLayoutOverrideId(null)
    ui.setSelectedLayoutType('choseong-jungseong-vertical')
    ui.setControlMode('layout')
    ui.setInputText('')
    ui.setShowInitialSample(true)
    ui.setSelectedCharIndex(0)
    ui.setFocusedSyllable(null)
    ui.setActiveMobileDrawer(null)
